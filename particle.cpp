...
particle::particle() {};
particle::particle(RealVector p, RealVector v, float min_speed, float max_speed):pos(p),vel(v),mns(min_speed),mas(max_speed){};
...
void particle::apply_Force(RealVector force){
  vel = vel.add(force);
